...
<div class="office">
    <div>
        О Нас
        <p>Наш офис нраходиться по адрессу: Краснодарский край, город Москва, улица Пушкина, дом Калатушкино 15</p>
        <p>картинка справа это наш офис, и склад одновременно</p>
        <p>Мне нужно чем-то заполнить, каким-то текстом, поэтому что-то пишу, всё равно никто читать это не будет, так что можно и всякого написать</p>
    </div>
    <img src="../images/office.jpg" alt="Наш офис">
</div>
...
<footer>
    © 2024 FLEX-MARKETㅤ<a style="text-decoration: none; color: #FFFFFF" href="https://e.mail.ru/" target="_blank">razrab@mail.ru</a>
</footer>
